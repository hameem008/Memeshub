...
function ImageUploaderCommunity() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        fetch(`http://localhost:3000/uploadmemecommunity/${caption}/${data.imageUrl}/${userId}/${communityId}`)
...
export default ImageUploaderCommunity;
